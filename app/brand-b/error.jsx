...
export const ERROR_DEFAULT_TITLE = 'Sorry, there is a problem with this page 😔'
export const ERROR_DEFAULT_MESSAGE = 'To continue, go back home.'
export const ERROR_NOT_FOUND_TITLE = 'Sorry, we cannot find this page 😓'
...
const Error = (props) => {
    ...
    const title = isNotFoundError ? ERROR_NOT_FOUND_TITLE : ERROR_DEFAULT_TITLE
    const message = ERROR_DEFAULT_MESSAGE
                ...
                <div className="t-error__container">
                    <div className="t-error__container-flexbox">
                        ...
                        <div className="t-error__container-content u-margin-top-lg u-margin-bottom-lg">
                            ...
                            <p className="u-margin-bottom-lg">BRAND B ERROR PAGE!</p>
